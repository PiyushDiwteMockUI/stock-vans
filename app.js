  ...
  cardHTML(v) {
    return `<article class="card">
      <div class="cardimg" data-act="view" data-id="${v.id}" style="position:relative;aspect-ratio:16/10;overflow:hidden;background:var(--line);cursor:pointer">
        ...
        ${v.model === 'Solara' ? '<img src="https://wonderlandrv.com.au/wp-content/uploads/2026/06/Coty-JCA-2-360x509.png" alt="Caravan of the Year 2026 Judges Choice Award" width="360" height="509" loading="lazy" style="position:absolute;top:0;right:16px;width:120px;height:auto;filter:drop-shadow(0 4px 10px rgba(0,0,0,.38))">' : ''}
