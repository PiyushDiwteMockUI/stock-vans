...
def gallery(v):
    ...
    return f'''<div class="vp-wrap"><div class="vp-main">
      ...
      {'<img src="https://wonderlandrv.com.au/wp-content/uploads/2026/06/Coty-JCA-2-724x1024.png" alt="Caravan of the Year 2026 Judges Choice Award" width="724" height="1024" style="position:absolute;top:0;right:24px;width:160px;height:auto;filter:drop-shadow(0 5px 12px rgba(0,0,0,.42))">' if v['model']=='Solara' else ''}
    </div>
    ...
    for key, title in groups:
        ...
        cards = ''.join(f'''<a href="{v['chassis'].lower()}.html" class="pagecard" style="text-decoration:none;background:#fff;border:1px solid var(--line2);border-radius:4px;overflow:hidden;display:flex;flex-direction:column;font-family:'Gordita',sans-serif">
          <div style="position:relative;aspect-ratio:16/10;background:var(--line)">
            ...
            {'<img src="https://wonderlandrv.com.au/wp-content/uploads/2026/06/Coty-JCA-2-724x1024.png" alt="Caravan of the Year 2026 Judges Choice Award" width="724" height="1024" loading="lazy" style="position:absolute;top:0;right:14px;width:110px;height:auto;filter:drop-shadow(0 4px 10px rgba(0,0,0,.38))">' if v['model']=='Solara' else ''}
          </div>
